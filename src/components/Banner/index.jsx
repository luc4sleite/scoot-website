...
export default function Banner() {
  return (
    <div className="flex flex-col justify-center items-center text-center gap-10 bg-home-hero-mobile bg-no-repeat bg-cover pt-28 pb-40 w-screen overflow-hidden">
