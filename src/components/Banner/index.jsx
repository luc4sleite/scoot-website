...
export default function Banner() {
  return (
    <div className="w-screen h-[650px] flex flex-col justify-center items-center lg:items-start text-center gap-10 bg-home-hero-mobile md:bg-home-hero-tablet lg:bg-home-hero-desktop bg-no-repeat bg-cover pt-28 pb-40 mb-[120px] overflow-hidden">
