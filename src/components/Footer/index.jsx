...
export default function Footer() {
  return (
    <footer className="bg-[#333A44] flex flex-col md:flex-row items-center justify-center md:justify-around lg:justify-between m-auto pt-[60px] md:h-[96px] md:p-0 md:m-0 lg:px-[165px]">
